...
argument_info(index, 1, modules, type(list(atom))).

predicate_info(module, arity(6)).
argument_info(module, 1, name, type(atom)).
...
argument_info(requires, 2, module_name, type(atom)).
argument_info(requires, 3, annotations, type(list(annotation))).

predicate_info(exports, arity(3)).
argument_info(exports, 1, package_name, type(atom)).
argument_info(exports, 2, to_modules, type(list(atom))). % Target modules, or '_' if public
...
argument_info(package_declaration, 1, package_name, type(atom)).
argument_info(package_declaration, 2, declared_types, type(list(type_declaration))).

predicate_info(type_declaration, arity(2)).
argument_info(type_declaration, 1, name, type(atom)).
argument_info(type_declaration, 2, category, type(atom)).

predicate_info(class, arity(9)).
argument_info(class, 1, name, type(atom)).
argument_info(class, 2, package_name, type(atom)).
...
argument_info(class, 7, permitted_subclasses, type(list(atom))).
argument_info(class, 8, members, type(list(member))).
argument_info(class, 9, annotations, type(list(annotation))).

predicate_info(interface, arity(7)).
argument_info(interface, 1, name, type(atom)).
argument_info(interface, 2, package_name, type(atom)).
...
predicate_info(record, arity(8)).
argument_info(record, 1, name, type(atom)).
argument_info(record, 2, package_name, type(atom)).
...
predicate_info(enum, arity(7)).
argument_info(enum, 1, name, type(atom)).
argument_info(enum, 2, package_name, type(atom)).
...
predicate_info(annotation_type, arity(5)).
argument_info(annotation_type, 1, name, type(atom)).
argument_info(annotation_type, 2, package_name, type(atom)).
...
predicate_info(method, arity(7)).
argument_info(method, 1, name, type(atom)).
...
predicate_info(constructor, arity(6)).
argument_info(constructor, 1, name, type(atom)).
...
predicate_info(field, arity(4)).
argument_info(field, 1, name, type(atom)).
...
argument_info(annotation_member, 1, name, type(atom)).
...
argument_info(parameter, 1, name, type(atom)).
...
argument_info(record_component, 1, name, type(atom)).
